import {
    ...
    DETAILS_SEND_MESSAGE, EMAIL_EXISTS,
    ...
    SIGN_UP_SCREEN_TITLE, SIGNUP_CONFIRM_PASSWORD_PLACEHOLDER, SIGNUP_CONFIRM_PASSWORD_VALIDATION_ERROR,
    SIGNUP_EMAIL_PLACEHOLDER, SIGNUP_EMAIL_VALIDATION_ERROR,
    SIGNUP_FIRST_NAME_PLACEHOLDER, SIGNUP_FIRST_NAME_VALIDATION_ERROR,
    SIGNUP_LAST_NAME_PLACEHOLDER, SIGNUP_LAST_NAME_VALIDATION_ERROR, SIGNUP_NAME_ORDER,
    SIGNUP_PASSWORD_PLACEHOLDER, SIGNUP_PASSWORD_VALIDATION_ERROR,
    SIGNUP_USERNAME_PLACEHOLDER, SIGNUP_USERNAME_VALIDATION_ERROR,
    SUBMIT_DOG_TITLE, USER_NAME_EXISTS
} from '../i18n.keys';
...
export default {
    ...
    [SIGNUP_USERNAME_VALIDATION_ERROR]: 'Olyan felhasználónevet válasszon ami legalább 5 karakter hosszú és az angol abc betűibol vagy szamokbol all.',
    [SIGNUP_PASSWORD_VALIDATION_ERROR]: 'Kerjuk adjon meg egy megfelelo jelszot. A jelszonak legalabb 8 karakter hosszunak kell lennie, ami tartalmaz legalabb egy szamot, kisbetut es nagybetut.',
    [SIGNUP_CONFIRM_PASSWORD_VALIDATION_ERROR]: 'A jelszavak nem egyeznek.',
    [SIGNUP_EMAIL_VALIDATION_ERROR]: 'Kerjuk adjon meg egy megfelelo email cimet.',
    [SIGNUP_FIRST_NAME_VALIDATION_ERROR]: 'Kerjuk adjon meg egy nevet.',
    [SIGNUP_LAST_NAME_VALIDATION_ERROR]: 'Please enter a name.',
